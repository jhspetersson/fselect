...
[deb package](https://github.com/jhspetersson/fselect/releases/download/0.9.3/fselect_0.9.3-1_amd64.deb)
...
[Static build with musl](https://github.com/jhspetersson/fselect/releases/download/0.9.3/fselect-x86_64-linux-musl.gz).

#### Windows 64bit

A statically precompiled [binary](https://github.com/jhspetersson/fselect/releases/download/0.9.3/fselect-x86_64-win.zip) is available at GitHub downloads.
