...
[Static build with musl](https://github.com/jhspetersson/fselect/releases/download/0.5.2/fselect-x86_64-linux-musl.gz).

#### Windows 64bit

A statically precompiled [binary](https://github.com/jhspetersson/fselect/releases/download/0.5.2/fselect-x86_64-win.zip) is available at Github downloads.

#### Mac

[Precompiled on OS X Mavericks 10.9.5](https://github.com/jhspetersson/fselect/releases/download/0.5.2/fselect-x86_64-apple-darwin.zip)
