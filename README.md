...
[Static build with musl](https://github.com/jhspetersson/fselect/releases/download/0.7.5/fselect-x86_64-linux-musl.gz).

#### Windows 64bit

A statically precompiled [binary](https://github.com/jhspetersson/fselect/releases/download/0.7.5/fselect-x86_64-win.zip) is available at Github downloads.
