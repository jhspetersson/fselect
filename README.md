...
[Static build with musl](https://github.com/jhspetersson/fselect/releases/download/0.6.1/fselect-x86_64-linux-musl.gz).
...
[Precompiled on OS X Mavericks 10.9.5](https://github.com/jhspetersson/fselect/releases/download/0.6.1/fselect-x86_64-apple-darwin.zip)
